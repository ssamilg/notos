...
export function LoginPage() {
  ...
  let formBody = (
    <form ref={formRef} aria-busy={pending !== null} className="flex flex-col gap-4">
  ...
  return (
    <main id="main-content" className="flex min-h-screen items-center justify-center bg-background px-6">
      <Card className="w-full max-w-sm">
        <CardContent className="pt-8">
          <div className="mb-6 text-center">
            <h1 className="text-heading glow-text-intense">NOTOS</h1>
            <p className="text-label mt-1 text-muted-foreground">Noise To Signal</p>
          </div>
